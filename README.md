...
## Icons
* Application icon provided by [Microsoft FluentUI Emoji 3D Icons](https://github.com/microsoft/fluentui-emoji) ([MIT License](https://spdx.org/licenses/MIT.html))
* Other icons provided by [FontAwesome Free](https://fontawesome.com/) ([CC BY 4.0 License](https://creativecommons.org/licenses/by/4.0/))
